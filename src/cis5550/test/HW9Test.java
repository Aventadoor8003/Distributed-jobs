...
//			tests.add("complex");
			...
			//add test: tag filter: try to make a unique word in a tag, and check if that word is excluded
			//add test: single page word url pair test
			//add test: simple set pair tests
		}
		// ENDIF
